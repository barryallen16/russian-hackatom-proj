...
const Navbar = () => {
    ...
    >
      <div
        className="flex w-full items-center justify-between overflow-y-hidden
         p-4 backdrop-blur-lg lg:m-2 lg:w-[50rem] lg:rounded-full lg:shadow-lg text-white"
      >
        {/* <img src={logo} alt="logo" width={80} height={22} /> */}
        <h1 className="font-display text-white">Terravision</h1>
 ...
 href={`#${link.targetId}`}
 className={`text-sm ${
   index !== 0 ? "border-l-2 border-neutral-300/20 pl-10 pr-8 text-white" : "pr-8 text-white"
 } hover:opacity-50`}
